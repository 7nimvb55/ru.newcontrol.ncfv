...
public class AppObjectsInfoHelperHtml {
    ...
    protected static ConcurrentSkipListMap<Integer, String> getLinesForSaveCss(){
        ...
        listForRunnableLogStrs.put(strIndex,"table {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    font-family: verdana,arial,sans-serif;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    border: 1px solid #999999;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    width: 350px;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    height: 200px;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    text-align: start;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    border-collapse: collapse;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table td, table th {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    border: 1px solid #999999;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    padding: 3px 2px;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table tbody td {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    font-size: 13px;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    color: #000000;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table tr:nth-child(even) {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    background: #666666;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table thead {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    background: #444444;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    border-bottom: 3px solid #999999;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table thead th {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    font-size: 17px;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    font-weight: bold;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    color: #FF8000;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    text-align: center;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    border-left: 2px solid #999999;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table thead th:first-child {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    border-left: none;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");

        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table tfoot {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    font-size: 14px;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    font-weight: bold;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    color: #333333;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    background: #555555;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    border-top: 3px solid #444444;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"table tfoot td {");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"    font-size: 14px;");
        strIndex++;
        listForRunnableLogStrs.put(strIndex,"}");
